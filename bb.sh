...
global_variables() {
    ...
    # Blog title
    global_title="Software In Our Lives"
    # The typical subtitle for each blog
    global_description="A blog about how can software impact out lives, for good of for worse"
    # The public base URL for this blog
    global_url="http://example.com/blog"

    # Your name
    global_author="p20sami"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="https://github.com/p20sami"
    global_email=""
